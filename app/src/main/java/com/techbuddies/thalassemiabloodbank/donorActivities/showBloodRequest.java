...
public class showBloodRequest extends AppCompatActivity {
    ...
    showbloodReqDonorAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.bloodRequestList);
    ...
    private void readdata() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new showbloodReqDonorAdapter(showBloodRequest.this, bloodRequestArrayList);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(showBloodRequest.this,"Oopps Error!",Toast.LENGTH_SHORT).show();
